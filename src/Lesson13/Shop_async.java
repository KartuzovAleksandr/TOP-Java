...
public class Shop_async {
    // Главный метод программы
    public static void main(String[] args) {
        Shop shop = new Shop("ЛучшийМагазин");
...
// Класс, моделирующий интернет-магазин с синхронным и асинхронным методами получения цены товара
class Shop {
